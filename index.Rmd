...
It’s hard to overstate the role technology plays in F1 racing. Every F1 car contains 300 sensors which generate 1.1 million telemetry data points per second transmitted from the cars to the pits. During each race weekend, 160 terabytes of data are sent between the remote race circuit and the F1 Media and Technology Center.

The world of Formula 1 contains a lot of questions and the study of data is a way to find solutions for some of these questions. For this project we decided to look at data to answer the following questions:
